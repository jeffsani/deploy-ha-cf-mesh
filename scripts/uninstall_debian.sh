...
# =============================================================================
# Cloudflare Mesh Connector Uninstall Script — Debian/Ubuntu
#
# Usage:
#   sudo ./uninstall_debian.sh <ACCOUNT_ID> <API_TOKEN>
#
# Arguments:
...
if command -v ufw &>/dev/null; then
  ...
  sudo ufw delete allow 2408/udp  2>/dev/null || true
  sudo ufw delete allow 500/udp   2>/dev/null || true
  sudo ufw delete allow 4500/udp  2>/dev/null || true
  sudo ufw delete allow 443/tcp   2>/dev/null || true
  sudo ufw delete allow 443/udp   2>/dev/null || true
  sudo ufw reload
